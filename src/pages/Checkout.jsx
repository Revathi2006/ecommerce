...
const saveOrder = async () => {
  try {
    ...
    const orderData = {
      ...
      paymentStatus: "Paid",
      status: "confirmed",            // ✅ New: initial status
      userId: user.uid,               // ✅ New: link to current user
      createdAt: serverTimestamp(),   // ✅ New: order creation time
      updatedAt: serverTimestamp(),   // ✅ New: last updated time
    };
    ...
    if (!snap.empty) {
      ...
      Swal.fire("Success", `Order placed! You earned ${earnedPoints} points. Total points: ${newPoints}`, "success");
    } else {
